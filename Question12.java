...
public class Question12 {
    private static final String DB_URL = "jdbc:mysql:///newdb";
    ...
    public static void main(String[] args) {
        try {
            ...
            // Insert a record
            int recordId = insertRecord(connection, "Sanny Kumar","sannykrmffp03@gmail.com");
            
            // Display all records
            displayAllRecords(connection);

            // Update the inserted record
            updateRecord(connection, recordId, "Abhishek  Kumar", "abi123@gmail.com");
